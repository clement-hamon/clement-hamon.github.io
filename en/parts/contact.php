            ...
            <div class="col-sm-9">
                ...
                <form id="contact-form" class="contact-form" action="#" method="post">
                    <div class="input-group">
                        <input class="form-control" id="contact_name" type="text" placeholder="Your name" value="" name="name" />
                    </div>
                    <div class="input-group">
                        <input class="form-control" id="contact_tel" type="text" placeholder="Your phone number" value="" name="tel" />
                    </div>
                    <div class="input-group">
                        <input class="form-control" id="contact_email" type="text" placeholder="Your email address" value="" name="email" />
                    </div>
                    <div class="input-group">
                        <textarea id="contact_message" placeholder="Your Message" name="message" rows="15" cols="40"></textarea>
                    </div>
                    <div class="input-group">
                        <input class="form-control" id="contact-submit" class="submit" type="submit" value="Send"/>
                    </div>
